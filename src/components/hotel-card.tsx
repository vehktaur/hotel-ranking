...
const HotelCard = ({ hotel }: { hotel: Hotel }) => {
  return (
    <div>
      <div className="h-full border border-[#ccc] hover:shadow-md cursor-pointer transition-all duration-500 rounded-xl px-5 py-6">
        <div className="flex flex-col h-full justify-between gap-3">
          ...
          <p className="flex items-center gap-1" title={`${hotel.rating}/5`}>
            Rating:
            <span className='flex'>
